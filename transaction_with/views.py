...
def transaction_with_page(request):
    return render(request, 'transaction_with/transaction_with_form.html')

def load_transaction_with(request):
...
def transaction_with_fetch_data(request):
...
def save_transaction_with(request):
...
def update_transaction_with(request):
    if request.method == "POST":      
        transactionmainheads_id = request.POST.get('transactionmainheads_id')
        tran_method = request.POST.get('tran_method')
...
def delete_transaction_with(request):
