$(document).ready(function () {
        ...
        currentRequest = $.ajax({
            ...
            success: function (response) {
                ...
                if (append) {
                    ...
                    offset = newOffset;
                    currentIndex = 0; // reset highlight if new search
                }

                renderTable();

                // 🔹 fix: check exact fetched rows
    ...
    $(document).on("keydown", function (e) {
        ...
        if (e.key === "ArrowDown") {
            ...
            // 🔹 simplified: always fetch next if more rows exist
            if (hasMore && !isLoading && currentIndex >= purchaseList.length - 5) {
                offset += limit;
