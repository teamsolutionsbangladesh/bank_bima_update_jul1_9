$(document).ready(function () {
    ...
    // =========================
    setTodayDate();
    loadPaymentList("", 0, false);  // ✅ changed
    ...
    $("#start_date, #end_date").on("change", function () {
        ...
        loadPaymentList(query, 0, false);  // ✅ changed
    });
    ...
    $("#printReportBtn").on("click", function () {
        ...
        let url = `/payment/report/pdf/?q=${encodeURIComponent(q)}&start_date=${start_date}&end_date=${end_date}`;  // ✅ changed
